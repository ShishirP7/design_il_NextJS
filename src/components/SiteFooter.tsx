...
export function SiteFooter(){
  return (
    <footer className="mt-8 bg-[#0c693c] text-white">
      <div className="container-section grid gap-10 py-16 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 text-lg font-extrabold"><span className="rounded-md bg-[#0c693c] px-2 py-1 text-white">Design Innovation Lab</span></div>
          <button className="mt-6 rounded-md border border-white text-white px-4 py-2 text-sm">CAREER WITH US</button>
        </div>
        <div>
          <div className="font-semibold">LINKS</div>
          <ul className="mt-4 space-y-2 text-sm text-slate-200">
            <li>About us</li><li>Expert Team</li><li>FAQs</li><li>Blog / News</li><li>Contact us</li>
          </ul>
        </div>
        <div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-2 flex rounded-md bg-white/10 p-1">
              <input className="flex-1 bg-transparent px-3 py-2 text-sm outline-none placeholder:text-white" placeholder="Enter your email to subscribe" />
